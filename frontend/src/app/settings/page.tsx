          ...
          <CardContent className="p-6 space-y-5">
            <div className="flex items-center gap-5">
              <Avatar className="h-16 w-16">
                <AvatarFallback className="bg-primary text-primary-foreground text-xl font-bold">MK</AvatarFallback>
              </Avatar>
              <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input defaultValue="Mohit" className="h-9 text-sm" />
              </div>
              <div>
                <label className="text-xs font-medium text-muted-foreground mb-1 block">Last Name</label>
                <Input defaultValue="Kumar" className="h-9 text-sm" />
              </div>
              <div className="col-span-2">
                <label className="text-xs font-medium text-muted-foreground mb-1 block">Email</label>
                <Input defaultValue="mohit.kumar@gmail.com" className="h-9 text-sm" />
              </div>
              <div className="col-span-2">
                <label className="text-xs font-medium text-muted-foreground mb-1 block">Mobile</label>
                <Input defaultValue="+91 9012345678" className="h-9 text-sm" />
              </div>
            </div>
